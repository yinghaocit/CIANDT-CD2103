      ...
      switch ($action) {
        ...
        case "double_right":
          ...
          $push_data[] = [
            'action' => $action,
            'topic' => $this->topic_zigbee . "/0x70ac08fffe65a18c/set",
            'payload' => json_encode(['ir_code_to_send' => '']),
          ];
          $ac = "检测到空调触发了[开启]操作";
          break;
      }
